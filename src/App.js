    ...
    <Router>
      <div className="App">
        <Routes>
          ...
          <Route path="/connection-distribution" element={<ConnectionDistribution />}/>
          <Route path="/adminview-connections" element={<AdminViewConnections />}/>
          ...
          <Route path="/connectionrequest"element={<ConnectionRequestForm />}/>
