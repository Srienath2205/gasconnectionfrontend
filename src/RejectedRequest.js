...
export default function RejectedRequests() {
  ...
  const id = sessionStorage.getItem("adminName");
  ...
  const loadRejectedRequests = async () => {
    try {
      const result = await axios.get(
        "http://localhost:8787/requestside/getRejectedRequestList"
      );
  ...
  return (
    <div>
      ...
      <center>
        <h2 className="distribution-title">Rejected Connection Requests</h2>
      </center>
      <div
